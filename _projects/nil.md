    ...
    <div class="col-md-10">
        ...
        <div id="video">
            <video controls preload="metadata" class="img-fluid rounded z-depth-1">
                <source src="{{ 'assets/video/nil.mp4' | relative_url }}" type="video/mp4">
...
<section class="section">
        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <video controls preload="metadata" class="img-fluid rounded z-depth-1">
                        <source src="{{ 'assets/video/results1.mp4' | relative_url }}" type="video/mp4">
                    </video>
                </div>
                <div class="col-md-10 mt-4">
                    <h5 class="text-center">Unitree H1 Humanoid and Talos Humanoid</h5>
                    <video controls preload="metadata" class="img-fluid rounded z-depth-1">
                        <source src="{{ 'assets/video/results2.mp4' | relative_url }}" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-10">
            ...
            <video controls preload="metadata" class="img-fluid rounded z-depth-1">
                <source src="{{ 'assets/video/rewardfunctioncomps.mp4' | relative_url }}" type="video/mp4">
            </video>
        </div>
    </div>
    <div class="row justify-content-center mt-5">
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <video controls preload="metadata" class="img-fluid rounded z-depth-1">
                        <source src="{{ 'assets/video/videomodels.mp4' | relative_url }}" type="video/mp4">
                    </video>
                </div>
                <div class="col-md-10 mt-4">
                    <h5 class="text-center">Effect of Model Improvements</h5>
                    <video controls preload="metadata" class="img-fluid rounded z-depth-1">
                        <source src="{{ 'assets/video/videomodelimprovements.mp4' | relative_url }}" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
